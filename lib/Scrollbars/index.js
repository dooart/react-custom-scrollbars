...
exports["default"] = (0, _react.createClass)({
    ...
    propTypes: {
        ...
        browserScrollbarWidth: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]),
    ...
    getBrowserScrollbarWidth: function getBrowserScrollbarWidth() {
        var browserScrollbarWidth = this.props.browserScrollbarWidth;

        if (browserScrollbarWidth > 0) return browserScrollbarWidth;
        return (0, _getScrollbarWidth2["default"])();
    },
    ...
    render: function render() {
        ...
        var containerProps = _extends({}, props, { style: containerStyle, ref: 'container' });
        delete containerProps.browserScrollbarWidth;

        return (0, _react.createElement)(tagName, containerProps, [(0, _react.cloneElement)(renderView({ style: viewStyle }), { key: 'view', ref: 'view' }, children), (0, _react.cloneElement)(renderTrackHorizontal({ style: trackHorizontalStyle }), { key: 'trackHorizontal', ref: 'trackHorizontal' }, (0, _react.cloneElement)(renderThumbHorizontal({ style: _styles.thumbHorizontalStyleDefault }), { ref: 'thumbHorizontal' })), (0, _react.cloneElement)(renderTrackVertical({ style: trackVerticalStyle }), { key: 'trackVertical', ref: 'trackVertical' }, (0, _react.cloneElement)(renderThumbVertical({ style: _styles.thumbVerticalStyleDefault }), { ref: 'thumbVertical' }))]);
    }
});